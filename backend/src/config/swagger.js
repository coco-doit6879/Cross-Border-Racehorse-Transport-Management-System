      ...
      schemas: {
        ...
        Horse: {
          ...
          properties: {
            ...
            feiPassportNumber: { type: 'string', example: 'FEI-2026-US-8891' },
            ...
            lastVaccinationDate: { type: 'string', format: 'date' },
            reviewStatus: { type: 'string', readOnly: true, enum: ['PENDING_REVIEW', 'APPROVED', 'REJECTED'] },
            __v: { type: 'integer', readOnly: true },
